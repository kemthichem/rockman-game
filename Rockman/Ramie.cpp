...
CRamie::CRamie(int _id, D3DXVECTOR3 _pos, bool _isCheckCollison)
{
	m_Id = _id;
	m_Type = BLOCK;
...
void CRamie::Update(float _deltaTime, CCamera *_camera, CInput *_input)
{
	//m_Sprite->IndexOf(0);
}

void CRamie::Render(LPD3DXSPRITE _sp, CCamera* _camera)
{
