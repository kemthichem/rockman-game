...
#define KITTY_IMAGE_RIGHT L"rockman_right.png"
#define KITTY_IMAGE_LEFT L"rockman_right.png"
#define KITTY_SPEED 0.2f
#define GROUND_Y 450

#define BACKGROUND_FILE L"bg.bmp"

#define ANIMATE_RATE 45
...
void CKitty::LoadResources(LPDIRECT3DDEVICE9 d3ddv)
{
	...
	kitty_right = new CSprite(_SpriteHandler,KITTY_IMAGE_RIGHT,24,24,3,3);
	kitty_left = new CSprite(_SpriteHandler,KITTY_IMAGE_LEFT,25,24,3,3);
}
